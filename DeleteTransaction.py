...
def delete_transaction():
    ...
    try:
        ...
        cursor.execute("SELECT * FROM feeding_fees WHERE id = %s", (transaction_id,))
        row = cursor.fetchone()
        ...
        insert_query = """
        INSERT INTO deleted_transactions (id, name, class, amount, created_at, status, last_insert, balance, student_id, reason)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
        """
        cursor.execute(insert_query, (*row, reason))
